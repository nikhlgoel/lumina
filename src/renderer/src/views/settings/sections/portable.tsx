...
import { HardDriveDownload, HardDriveUpload, RefreshCw, Usb } from 'lucide-react';
import type { PortableDrive, PortableTransfer } from '@shared/types';
import { formatBytes, plural } from '@core/format';
import { call, errorMessage, on } from '@/lib/bridge';
import { cn } from '@/lib/cn';
import { useApp } from '@/stores/app';
import { Button, EmptyState, ProgressBar, Switch } from '@/components/ui';
