...
const STEPS: { name: string; script: string; delay?: number }[] = [
  ...
  { name: '30-about', script: "document.documentElement.dataset.theme='dark'; [...document.querySelectorAll('nav[aria-label=Main] button')][4].click()", delay: 1400 },
  ...
  { name: '50-browser', script: "document.documentElement.dataset.theme='dark'; [...document.querySelectorAll('nav[aria-label=Main] button')][3].click()", delay: 2500 },
